...
public static class Strings
{
    ...
    /// </summary>
    /// <param name="input">string to check</param>
    public static bool IsNotNows([NotNullWhen(false)] this string? input)
    {
        return !input.IsNows();
    }
    ...
    public static bool TryTo([NotNullWhen(false)] this string? input, out bool value)
    {
    ...
    /// <param name="input">string to parse</param>
    /// <param name="value">parsed value</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out Guid value)
    {
    ...
    public static bool TryTo([NotNullWhen(false)] this string? input, out int value, NumberStyles style = NumberStyles.Any,
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out long value, NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out byte value, NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out sbyte value, NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out short value, NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out ushort value, NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out uint value, NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out ulong value, NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out float value, NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out double value, NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out decimal value, NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out DateTime value, DateTimeStyles style = DateTimeStyles.None,
        IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out DateTime value, string format,
        DateTimeStyles style = DateTimeStyles.None, IFormatProvider? formatProvider = null)
    {
    ...
    /// <param name="style">style to use during parsing</param>
    /// <param name="formatProvider">format provider</param>
    public static bool TryTo([NotNullWhen(false)] this string? input, out DateTime value, string[] formats,
        DateTimeStyles style = DateTimeStyles.None, IFormatProvider? formatProvider = null)
    {
